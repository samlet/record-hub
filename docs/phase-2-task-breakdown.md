...
| P2-1-003 | Source/mapping registry | IN_PROGRESS | [phase-2-source-mapping-design.md](phase-2-source-mapping-design.md) 已冻结 source/mapping 模型、发布校验和 runtime 精确 lookup；API、持久化和 generation 切换仍待实现 |
