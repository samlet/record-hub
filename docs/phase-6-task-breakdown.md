...
| P6-001 | 四仓库 | connector/schema inventory | [inventory](phase-6-connector-schema-inventory.json)；owner/action/schemaVersion/PII/scope 矩阵 | IN_PROGRESS |
...
| ID | 范围 | 任务 | 交付物 | 状态 |
| --- | --- | --- | --- | --- |
| P6-100 | Record Hub | schema.org 语义和继承 registry | IRI allowlist、版本、兼容检查 | TODO |
| P6-101 | Record Hub | tags、tag dictionary 和 audit | 受控 tag、互斥组、scope API | TODO |
