...
| ID | 范围 | 任务 | 交付物 | 状态 |
| --- | --- | --- | --- | --- |
| P6-200 | Record Hub | connector registry lifecycle | exact match、enable/disable、owner、compatibility；[registry contract](phase-6-connector-registry.json) 已通过静态 gate | IN_PROGRESS |
