...
| P3-110 | Record Hub/Fluxion | live command E2E | PARTIAL | 核心切片与 `make p3-fluxion-command-faults` 的双 worker、commit-before-ACK replay、result consumer restart、NATS outage/backlog recovery、result poison DLQ 已实现；跨系统同时重启仍待后续批次 |
