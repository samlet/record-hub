...
make p3-nats-outage-recovery  # P3-403：真实 Fluxion summary outbox 的 NATS outage/backlog/recovery
```
...
P3-403 的 outage/recovery gate 与证据见 [phase-3-batch4c-nats-recovery.md](phase-3-batch4c-nats-recovery.md)。
