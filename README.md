...
- [Phase 4 Batch 2 P4-201 closure](docs/phase-4-batch2-p4-201.md)
- [Phase 4 Batch 2 P4-202 closure](docs/phase-4-batch2-p4-202.md)
...
- [Phase 5 技术方案](docs/phase-5-design.md)
- [Phase 5 需求基线](docs/phase-5-requirements.md)
- [Phase 5 任务分解](docs/phase-5-task-breakdown.md)
- [Phase 5 验收计划](docs/phase-5-acceptance-plan.md)
- [Phase 5 baseline manifest](docs/phase-5-baseline-manifest.json)
- [Phase 6 技术方案](docs/phase-6-design.md)
- [Phase 6 需求基线](docs/phase-6-requirements.md)
...
- [Phase 6 Batch 0 closure](docs/phase-6-batch0-closure.md)
- [Phase 6 Batch 1 P6-100 schema registry](docs/phase-6-batch1-p6-100.md)
- [Phase 6 Batch 1 P6-101 controlled tags](docs/phase-6-batch1-p6-101.md)
- [Phase 6 Batch 1 P6-102 typed relations](docs/phase-6-batch1-p6-102.md)
- [Phase 6 Batch 1 P6-103 views and safe export](docs/phase-6-batch1-p6-103.md)
- [Phase 6 Batch 2 P6-200 connector registry](docs/phase-6-batch2-p6-200.md)
- [Phase 6 Batch 2 P6-201 SDK parity inventory](docs/phase-6-batch2-p6-201.md)
- [Phase 6 Batch 2 P6-202 workload identity audit](docs/phase-6-batch2-p6-202.md)
- [Phase 6 Batch 2 P6-203 connector fault matrix](docs/phase-6-batch2-p6-203.md)
...
- [Phase 6 static closure](docs/phase-6-closure.md)
