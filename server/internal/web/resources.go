...
func NewConsoleRouter(recordsHandler, schemaHandler, operationsHandler http.Handler) http.Handler {
	resources := NewResourceRouter(recordsHandler, schemaHandler)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
