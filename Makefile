...
p6-nats-event-evidence:
	./scripts/verify-p6-nats-event-evidence.sh

p6-event-table-evidence:
	./scripts/verify-p6-event-table-evidence.sh
...
p4-501-native:
	./scripts/verify-p4-501-native.sh
...
p6-503-dry-run:
	./scripts/verify-p6-503-runbook-dry-run.sh

p6-600:
	./scripts/verify-p6-600-mixed-load.sh

p6-600-dry-run:
	./scripts/verify-p6-600-capacity-dry-run.sh

p6-601:
	./scripts/verify-p6-601-retention-restore.sh

p6-601-dry-run:
	./scripts/verify-p6-601-restore-dry-run.sh
