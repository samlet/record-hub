...
本地开发使用 Dex 2.45.1、SQLite 持久化和密码数据库，为 Approver、Fluxion、Bids、Record Hub 注册四个彼此独立的 confidential Web client。issuer 固定为 `http://127.0.0.1:5556/dex`，避免不同应用对 `localhost`、容器名或端口形成不一致的身份主键。
